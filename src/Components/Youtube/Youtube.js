...
class Youtube extends Component {
  ...
  componentDidMount() {
    fetch(
      "https://www.googleapis.com/youtube/v3/search?key=AIzaSyD3HQWNeZxlB4sZHJC_BtvCXPxcEuY7Zt4&channelId=UCE_M8A5yxnLfW0KghEeajjw&part=snippet,id&order=date&maxResults=9"
    )
                ...
                <div key={i} className="col-sm-12 col-md-4">
                  <div className="singleVideoWrapper">
                    ...
                    <div className="videoInfoWrapper">
                      ...
                      <div className="videoDesc">
                        {singleVideo.snippet.publishTime.da}
                      </div>
                    </div>
                  </div>
                </div>
